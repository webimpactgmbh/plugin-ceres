  ...
  <div class="row">
    ...
    <template v-if="value.showPickupStation && selectedCountry.isoCode2 === 'DE' && addressType === '2'">
      ...
      <div class="col-12">
        <div class="row">
          <div
            v-if="isInOptionalFields('de', 'delivery_address.title')"
            class="col-12 col-sm-4"
          >
            <div
          ...
          <!-- Additional name -->
          <div
            v-if="isInOptionalFields('de', 'delivery_address.name4')"
            class="col-12 col-sm-4"
          >
            <div
          ...
          <!-- Phone number -->
          <div
            v-if="isInOptionalFields('de', 'delivery_address.phoneNumber')"
            class="col-12 col-sm-4"
          >
            <div
      ...
      <div
        v-if="isParcelOrOfficeAvailable"
        class="col-12"
      >
        <div class="row">
          <div class="col-12">
            <input
              ...
              type="checkbox"
              name="togglePickup"
              :checked="value.showPickupStation"
              @change="togglePickupStation($event.target.checked)"
            >
        ...
        <div class="row">
          ...
          <div class="col-12 col-sm-8">
            ...
            >
              ...
              >
                <option
                  v-if="isParcelBoxAvailable"
                  value="PACKSTATION"
                  :selected="isPickupStation"
                >
                  {{ $translate("Ceres::Template.addressPackingStation") }}
                </option>
                <option
                  v-if="isPostOfficeAvailable"
                  value="POSTFILIALE"
                  :selected="isPostOffice"
                >
      ...
      <div class="col-12">
        <div class="row">
          ...
          <div
            v-if="isInOptionalFields('de', 'delivery_address.address4')"
            class="col-12 col-sm-6"
          >
            <div
      ...
      <slot name="custom-address-fields" />
    </template>
    <!-- BillingAddressDE -->
    <template v-else-if="localeToShow == 'DE' && addressType === '1'">
      <div class="col-12">
        <div class="row">
          <div
            v-if="isInOptionalFields('de', 'billing_address.salutation')"
            class="col-12 col-sm-4"
          >
            <div
          ...
          >
            ...
            >
              <input
                ...
                data-autofocus
                @input="emitInputEvent('vatNumber', $event.target.value)"
              >
      ...
      <div class="col-12">
        <div class="row">
          <div
            v-if="isInOptionalFields('de', 'billing_address.title')"
            class="col-12 col-sm-4"
          >
            <div
          ...
          <div
            v-if="isInOptionalFields('de', 'billing_address.name4')"
            class="col-12 col-sm-4"
          >
            <div
          ...
          <div
            v-if="isInOptionalFields('de', 'billing_address.birthday')"
            class="col-12 col-sm-4"
          >
            <div
            ...
            >
              <input
                ...
                name="birthday"
                :placeholder="$translate('Ceres::Template.addressBirthdatePlaceholder')"
          ...
          <div
            v-if="isInOptionalFields('de', 'billing_address.phoneNumber')"
            class="col-12 col-sm-4"
          >
            <div
      ...
      <div class="col-12">
        <div class="row">
          <div
            v-if="isInOptionalFields('de', 'billing_address.address3')"
            class="col-12 col-sm-6"
          >
            <div
          ...
          <div
            v-if="isInOptionalFields('de', 'billing_address.address4')"
            class="col-12 col-sm-6"
          >
            <div
    ...
    <template v-else-if="localeToShow == 'GB' && addressType === '1'">
      <div class="col-12">
        <div class="row">
          <div
            v-if="isInOptionalFields('gb', 'billing_address.salutation')"
            class="col-12 col-sm-4"
          >
            <div
      ...
      <div class="col-12">
        <div class="row">
          <div
            v-if="isInOptionalFields('gb', 'billing_address.title')"
            class="col-12 col-sm-4"
          >
            <div
          ...
          <div
            v-if="isInOptionalFields('gb', 'billing_address.name4')"
            class="col-sm-4"
          >
            <div
          ...
          <div
            v-if="isInOptionalFields('gb', 'billing_address.birthday')"
            class="col-12 col-sm-4"
          >
            <div
          ...
          <div
            v-if="isInOptionalFields('gb', 'billing_address.phoneNumber')"
            class="col-12 col-sm-4"
          >
            <div
      ...
      <div class="col-12">
        <div class="row">
          ...
          <div
            v-if="isInOptionalFields('gb', 'billing_address.address2')"
      ...
      <div class="col-12">
        <div class="row">
          <div
            v-if="isInOptionalFields('gb', 'billing_address.address3')"
            class="col-12 col-sm-12"
          >
            <div
          ...
          <div
            v-if="isInOptionalFields('gb', 'billing_address.address4')"
            class="col-12 col-sm-12"
          >
            <div
    ...
    <template v-else-if="localeToShow == 'DE' && addressType === '2'">
      ...
      <div class="col-12">
        <div class="row">
          <div
            v-if="isInOptionalFields('de', 'delivery_address.address3')"
            class="col-12 col-sm-6"
          >
            <div
    ...
    <template v-else-if="localeToShow == 'GB' && addressType === '2'">
      <div class="col-12">
        <div class="row">
          <div
            v-if="isInOptionalFields('gb', 'delivery_address.salutation')"
            class="col-12 col-sm-4"
          >
            <div
      ...
      <div class="col-12">
        <div class="row">
          <div
            v-if="isInOptionalFields('gb', 'delivery_address.title')"
            class="col-12 col-sm-4"
          >
            <div
          ...
          <div
            v-if="isInOptionalFields('gb', 'delivery_address.name4')"
            class="col-12 col-sm-4"
          >
            <div
          ...
          <div
            v-if="isInOptionalFields('gb', 'delivery_address.phoneNumber')"
            class="col-12 col-sm-4"
          >
            <div
      ...
      <div class="col-12">
        <div class="row">
          ...
          <div
            v-if="isInOptionalFields('gb', 'delivery_address.address2')"
            class="col-12 col-sm-12"
          >
            <div
      ...
      <div class="col-12">
        <div class="row">
          <div
            v-if="isInOptionalFields('gb', 'delivery_address.address3')"
            class="col-12 col-sm-6"
          >
            <div
          ...
          <div
            v-if="isInOptionalFields('gb', 'delivery_address.address4')"
            class="col-12 col-sm-12"
          >
            <div
