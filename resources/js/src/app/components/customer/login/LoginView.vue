  ...
  <div class="container-max mt-5">
    <div class="row mb-5">
      <div class="col-sm-10 offset-sm-1 col-md-6 offset-md-3">
        ...
        <div class="row">
          <div
            class="col-sm-{% if 'my-account' not in backlink %}6{% else %}12{% endif %}"
        ...
        <slot name="additional-content-after-buttons" />
      </div>
    </div>
