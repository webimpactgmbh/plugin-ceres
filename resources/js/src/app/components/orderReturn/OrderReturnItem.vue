        ...
        <div class="meta-container-wrapper-inner">
          <div class="meta-container">
            <div class="position-relative w-100">
              ...
              <item-bundle
                ...
                :bundle-components="orderItem.bundleComponents"
              />
              ...
              <div
                v-if="orderItem.orderProperties"
                class="item-small-prices text-muted small"
              >
                <div
                  v-for="(property, index) in orderItem.orderProperties"
                  :key="index"
                >
          ...
          <div class="basket-item-container-right ml-3">
            ...
            <div class="price-box ml-2">
              <div
                v-if="isNet"
                class="item-total-price font-weight-bold text-right text-nowrap"
              >
        ...
        >
          ...
          <template v-if="isDataFieldVisible('availability') && variation.variation.availability.names.name">
            <div>
              ...
              <span
                class="badge"
                :class="'availability_' + variation.variation.availability.id"
              >
          ...
          <template v-if="isDataFieldVisible('description_long') && variation.texts.description">
            <p
              class="my-3"
              v-html="variation.texts.description"
            />
          </template>
          ...
          <template v-if="isDataFieldVisible('description_short') && variation.texts.shortDescription">
            <p
              class="my-3"
              v-html="variation.texts.shortDescription"
            />
          </template>
        </div>
      </div>
