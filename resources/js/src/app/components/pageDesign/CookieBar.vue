<template>
  <div
    class="cookie-bar"
    :class="{ 'out': !isVisible, 'border-top bg-white': isVisible, 'fixed-bottom': !isShopBuilder || false }"
  >
    <div
      v-if="isVisible"
      class="container-max"
    >
      ...
      >
        <div class="col-12 mb-3">
          <privacy-settings :consent-groups="consentGroups" />
        </div>
    ...
    <div v-else>
      ...
      >
        <i class="fa fa-shield float-none" />
