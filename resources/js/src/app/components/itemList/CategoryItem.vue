  ...
  <article class="cmp cmp-product-thumb">
    ...
    >
      ...
      <slot name="store-special">
        <item-store-special
          v-if="storeSpecial || item.variation.bundleType === 'bundle'"
      ...
      <slot name="item-details">
        <div class="thumb-content">
          ...
          >
            {{ item | itemName }}<!--
                    --><span
v-for="(attribute, index) in item.groupedAttributes"
:key="index"
>{{ "Ceres::Template.itemGroupedAttribute" | translate(attribute) }}</span>
          </a>
          ...
          <span class="vat small text-muted">
            * <span v-if="showNetPrices">{{ $translate("Ceres::Template.itemExclVAT") }}</span>
            ...
            <a
              v-if="$ceres.config.global.hasShippingCostsCategoryId > 0"
              data-toggle="modal"
              href="#shippingscosts"
