...
/* harmony import */ var _mixins_buttonSizeProperty_mixin__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../mixins/buttonSizeProperty.mixin */ "./resources/js/src/app/mixins/buttonSizeProperty.mixin.js");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  mixins: [_mixins_buttonSizeProperty_mixin__WEBPACK_IMPORTED_MODULE_6__["ButtonSizePropertyMixin"]],
  ...
  methods: {
    validateData() {
      ...
      _services_ValidationService__WEBPACK_IMPORTED_MODULE_2__["default"].validate($("#newsletter-unsubscribe-input-form_" + this._uid)).done(() => {
        this.save();
      }).fail(invalidFields => {
    ...
    save() {
      ...
      if (Object(_helper_utils__WEBPACK_IMPORTED_MODULE_5__["isUndefined"])(urlParams.folderId)) {
        urlParams.folderId = 0;
      }

      _services_ApiService__WEBPACK_IMPORTED_MODULE_1__["default"].del("/rest/io/customer/newsletter/" + this.email, {
        "emailFolder": urlParams.folderId,
        "honeypot": this.honeypot
      }).done(() => {
        _services_NotificationService__WEBPACK_IMPORTED_MODULE_3__["default"].success(this.$translate("Ceres::Template.newsletterOptOutSuccessMessage")).closeAfter(3000);
        this.resetInputs();
      }).fail(() => {
        _services_NotificationService__WEBPACK_IMPORTED_MODULE_3__["default"].error(this.$translate("Ceres::Template.newsletterOptOutErrorMessage")).closeAfter(5000);
      }).always(() => {
        this.isDisabled = false;
      });
    },
