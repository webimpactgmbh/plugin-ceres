...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    validate() {
      _services_ValidationService__WEBPACK_IMPORTED_MODULE_2__["default"].validate(this.$refs.form).done(() => {
        this.authGuest();
      }).fail(invalidFields => {
    ...
    authGuest() {
      ...
      _services_ApiService__WEBPACK_IMPORTED_MODULE_1__["default"].post("/rest/io/guest", {
        ...
        Object(_services_UrlService__WEBPACK_IMPORTED_MODULE_3__["navigateTo"])(Object(_helper_utils__WEBPACK_IMPORTED_MODULE_4__["isDefined"])(this.backlink) && this.backlink.length ? decodeURIComponent(this.backlink) : window.location.origin);
      }).fail(() => {
