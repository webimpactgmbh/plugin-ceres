...
/* harmony import */ var _helper_number__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../helper/number */ "./resources/js/src/app/helper/number.js");
...
/* harmony import */ var _helper_debounce__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../helper/debounce */ "./resources/js/src/app/helper/debounce.js");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  created() {
    this.compInterval = Object(_helper_utils__WEBPACK_IMPORTED_MODULE_2__["defaultValue"])(this.compInterval, 1);
    this.compInterval = this.compInterval === 0 ? 1 : this.compInterval;
    this.compDecimals = Object(_helper_number__WEBPACK_IMPORTED_MODULE_1__["floatLength"])(this.compInterval);
    this.onValueChanged = Object(_helper_debounce__WEBPACK_IMPORTED_MODULE_3__["debounce"])(() => {
      this.$emit("quantity-change", this.compValue);
    }, Object(_helper_utils__WEBPACK_IMPORTED_MODULE_2__["defaultValue"])(this.timeout, 500));

    if (!Object(_helper_utils__WEBPACK_IMPORTED_MODULE_2__["isNullOrUndefined"])(this.variationId)) {
  ...
  computed: _objectSpread({
    variationBasketQuantity() {
      ...
      if (this.itemSetVariationId > 0 && this.variationId !== this.itemSetVariationId) {
        ...
        var basketObject = this.$store.state.basket.items.find(variations => variations.variationId === this.variationId);
        return basketObject ? basketObject.quantity : 0;
      }
    },

    isMinimum() {
      return Object(_helper_utils__WEBPACK_IMPORTED_MODULE_2__["isDefined"])(this.compMin) && this.compValue - this.compInterval < this.compMin;
    },

    isMaximum() {
      return Object(_helper_utils__WEBPACK_IMPORTED_MODULE_2__["isDefined"])(this.compMax) && this.compValue + this.compInterval > this.compMax;
    },
  ...
  watch: {
    basketItems: {
      handler(newValue, oldValue) {
        if (Object(_helper_utils__WEBPACK_IMPORTED_MODULE_2__["isDefined"])(this.variationId)) {
          this.fetchQuantityFromBasket();
        }
      },
  ...
  methods: {
    increaseValue() {
      var newValue = Object(_helper_number__WEBPACK_IMPORTED_MODULE_1__["formatFloat"])(this.compValue + this.compInterval, this.compDecimals);

      if ((Object(_helper_utils__WEBPACK_IMPORTED_MODULE_2__["isNullOrUndefined"])(this.compMax) || newValue <= this.compMax) && !this.waiting) {
        this.setValue(newValue);
      }
    },
    ...
    decreaseValue() {
      ...
      if ((Object(_helper_utils__WEBPACK_IMPORTED_MODULE_2__["isNullOrUndefined"])(this.compMin) || newValue >= this.compMin) && !this.waiting) {
        this.setValue(newValue);
      }
    },
    ...
    setValue(value) {
      ...
      if (isNaN(value)) {
        value = Object(_helper_utils__WEBPACK_IMPORTED_MODULE_2__["defaultValue"])(this.compMin, 1);
      } // limit new value to min/ max value


      value = Object(_helper_number__WEBPACK_IMPORTED_MODULE_1__["limit"])(value, this.compMin, this.compMax); // make sure, new value is an even multiple of interval

      var diff = Object(_helper_number__WEBPACK_IMPORTED_MODULE_1__["formatFloat"])(value % this.compInterval, this.compDecimals, true);
      ...
      if (diff > 0 && diff !== this.compInterval) {
        ...
        value = Object(_helper_number__WEBPACK_IMPORTED_MODULE_1__["limit"])(value, this.compMin, this.compMax);
      } // cut fraction


      value = Object(_helper_number__WEBPACK_IMPORTED_MODULE_1__["formatFloat"])(value, this.compDecimals);

      if (value !== this.compValue) {
        this.compValue = value;
        this.onValueChanged();
      } else if (!Object(_helper_utils__WEBPACK_IMPORTED_MODULE_2__["isNullOrUndefined"])(this.$refs.quantityInputField)) {
        this.$refs.quantityInputField.value = value;
      }
    },

    fetchQuantityFromBasket() {
      if (!Object(_helper_utils__WEBPACK_IMPORTED_MODULE_2__["isNullOrUndefined"])(this.min) && this.variationBasketQuantity >= this.min) {
      ...
      if (!Object(_helper_utils__WEBPACK_IMPORTED_MODULE_2__["isNullOrUndefined"])(this.max)) {
