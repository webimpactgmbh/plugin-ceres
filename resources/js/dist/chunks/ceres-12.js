  ...
  methods: {
    ...
    sendLogin() {
      ...
      _services_ApiService__WEBPACK_IMPORTED_MODULE_1__["default"].post("/rest/io/customer/login", {
        ...
        _services_NotificationService__WEBPACK_IMPORTED_MODULE_2__["default"].success(this.$translate("Ceres::Template.loginSuccessful")).closeAfter(10000);
    ...
    showResetPwdView() {
      ...
      if (this.modalElement) {
        _services_ModalService__WEBPACK_IMPORTED_MODULE_3__["default"].findModal(document.getElementById(this.modalElement)).hide().then(() => {
