  ...
  methods: {
    initializeCarousel() {
      $("#owl-carousel-" + this._uid).owlCarousel({
        ...
        onInitialized: event => {
          if (this.showNav) {
            document.querySelector("#owl-nav-text-left-".concat(this._uid)).parentElement.onclick = event => event.preventDefault();

            document.querySelector("#owl-nav-text-right-".concat(this._uid)).parentElement.onclick = event => event.preventDefault();
          }
        }
      });
    },
