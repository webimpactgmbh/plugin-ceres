...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    initializeStoreSpecial() {
      if (!Object(_helper_utils__WEBPACK_IMPORTED_MODULE_2__["isNullOrUndefined"])(this.storeSpecial)) {
    ...
    getLabel() {
      if (!Object(_helper_utils__WEBPACK_IMPORTED_MODULE_2__["isNullOrUndefined"])(this.storeSpecial) && this.storeSpecial.id === 1 && !Object(_helper_utils__WEBPACK_IMPORTED_MODULE_2__["isNullOrUndefined"])(this.recommendedRetailPrice)) {
    ...
    getPercentageSale() {
      ...
      if (Object(_helper_utils__WEBPACK_IMPORTED_MODULE_2__["isDefined"])(this.specialOfferPrice)) {
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    initializeDataAndTimer() {
      var momentNow = dayjs__WEBPACK_IMPORTED_MODULE_2___default()();
      this.momentBegin = dayjs__WEBPACK_IMPORTED_MODULE_2___default.a.unix(this.liveShoppingData.liveShopping.fromTime);
      this.momentEnd = dayjs__WEBPACK_IMPORTED_MODULE_2___default.a.unix(this.liveShoppingData.liveShopping.toTime);
