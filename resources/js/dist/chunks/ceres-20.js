...
/* harmony import */ var _helper_whenConsented__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../helper/whenConsented */ "./resources/js/src/app/helper/whenConsented.js");
  ...
  methods: {
    createScript() {
      return new Promise((resolve, reject) => {
        ...
        if (!Object(_helper_utils__WEBPACK_IMPORTED_MODULE_2__["isNullOrUndefined"])(script)) {
          // script already injected...
          this.scriptBlocked = false;

          if (Object(_helper_utils__WEBPACK_IMPORTED_MODULE_2__["isNullOrUndefined"])(window.google)) {
            // ...but not loaded yet
          ...
          // script not loaded
          Object(_helper_whenConsented__WEBPACK_IMPORTED_MODULE_1__["whenConsented"])("media.googleMaps", () => {
            this.scriptBlocked = false;
