...
/* harmony import */ var _services_ValidationService__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../../services/ValidationService */ "./resources/js/src/app/services/ValidationService.js");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  mounted() {
    this.$nextTick(() => {
      ...
      if (!Object(_helper_utils__WEBPACK_IMPORTED_MODULE_6__["isNullOrUndefined"])(urlParams.show) && urlParams.show === "forgotPassword") {
        _services_ModalService__WEBPACK_IMPORTED_MODULE_3__["default"].findModal(this.$refs.pwdModal).show();
        this.username = !Object(_helper_utils__WEBPACK_IMPORTED_MODULE_6__["isNullOrUndefined"])(urlParams.email) ? urlParams.email : "";
      }
    });
  },
  ...
  methods: {
    validateResetPwd() {
      _services_ValidationService__WEBPACK_IMPORTED_MODULE_4__["default"].validate(this.$refs.pwdModal).done(() => {
        this.sendResetPwd();
      }).fail(invalidFields => {
        _services_ValidationService__WEBPACK_IMPORTED_MODULE_4__["default"].markInvalidFields(invalidFields, "error");
      });
    },
    ...
    sendResetPwd() {
      ...
      _services_ApiService__WEBPACK_IMPORTED_MODULE_1__["default"].post("/rest/io/customer/password_reset", {
        email: this.username,
        honeypot: this.honeypot
      }).done(() => {
        _services_ModalService__WEBPACK_IMPORTED_MODULE_3__["default"].findModal(this.$refs.pwdModal).hide();
        this.isDisabled = false;
        _services_NotificationService__WEBPACK_IMPORTED_MODULE_2__["default"].success(this.$translate("Ceres::Template.loginSendEmailOk")).closeAfter(5000);
      }).fail(() => {
        this.isDisabled = false;
        _services_NotificationService__WEBPACK_IMPORTED_MODULE_2__["default"].error(this.$translate("Ceres::Template.loginResetPwDErrorOnSendEmail")).closeAfter(5000);
      });
    },

    cancelResetPwd() {
      this.resetError();
      _services_ModalService__WEBPACK_IMPORTED_MODULE_3__["default"].findModal(this.$refs.pwdModal).hide().then(() => {
        _services_ModalService__WEBPACK_IMPORTED_MODULE_3__["default"].findModal(document.getElementById("login")).show();
      });
    },

    resetError() {
      _services_ValidationService__WEBPACK_IMPORTED_MODULE_4__["default"].unmarkAllFields(this.$refs.pwdModal);
    }
